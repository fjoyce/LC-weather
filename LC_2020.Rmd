...
```{r}
LC1 <- read.csv("Las_Cruces_2020/LC1.csv")

LC2 <- read.csv("Las_Cruces_2020/LC2.csv")

LC3 <- read.csv("Las_Cruces_2020/LC3.csv")

LC4 <- read.csv("Las_Cruces_2020/LC4.csv")

LC5 <- read.csv("Las_Cruces_2020/LC5.csv")

LC6 <- read.csv("Las_Cruces_2020/LC6.csv")
...
ggsave("LCBS_2020_daily_rain.png", daily_rain, width = 7, height = 5)
