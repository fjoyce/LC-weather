...
ggsave("figures/combined_cumulative_2023_labeled_through_July.png", plot = cumulative_curves, width = 8, height = 5)
```
...
ggsave("annual_rain.png", annual_rain_plot, width = 7, height = 5)
```
