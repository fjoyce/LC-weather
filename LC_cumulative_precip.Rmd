...
```{r}
LC_2005_2008 <- read.csv("LC_met_Jan05t_Jul08.csv")
...
LC_2008_2020 <- read.csv("datos_meteorologicos_LC_Aug08_Jun20.csv", na.strings = "NA" )
...
```{r warning=FALSE}
LC_2020A <- read.csv("Las_Cruces_2020/LC1.csv")
LC_2020B <- read.csv("Las_Cruces_2020/LC2.csv")
LC_2020C <- read.csv("Las_Cruces_2020/LC3.csv")
LC_2020D <- read.csv("Las_Cruces_2020/LC4.csv")
LC_2020E <- read.csv("Las_Cruces_2020/LC5.csv")
LC_2020F <- read.csv("Las_Cruces_2020/LC6.csv")
...
LC_2021 <- read.csv("LC_weather_2021.csv")
...
LC_2022 <- read.csv("2022/LC_weather_2022.csv")
...
#print
cumulative_curves
ggsave("combined_cumulative_2022-11.png", plot = cumulative_curves, width = 8, height = 5)
```
